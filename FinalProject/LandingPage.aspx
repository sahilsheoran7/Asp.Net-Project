...
<body class="body1">
            ...
            <div class="container">
                ...
                <div class="jumbotron">
                    <div class="col-sm-8 col-sm-offset-2 text">
                        <h1>Welcome To World Traveller Website</h1>
                    </div>
                </div>
                            ...
                            <div class="form-box">
                                ...
                                <div class="form-bottom">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="lblLname" runat="server" Text="Username" CssClass="col-form-label"></asp:Label>
                                        <asp:TextBox ID="txtLname" runat="server" ValidationGroup="login" CssClass="form-control"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        <asp:Button ID="btnsub" runat="server" Text="Sign in!" CssClass="btn btn-block" OnClick="btnsub_Click" ValidationGroup="login" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-box">
                                ...
                                <div class="form-bottom">
                                    ...
                                    <div class="form-group">
                                        <asp:Button ID="btnsign" runat="server" Text="Sign me up!" CssClass="btn btn-block" OnClick="btnsign_Click" />
    ...
    <footer class="card-footer">
        <p class="text-center">Copyright &copy; 2018 to Sahil</p>
    </footer>
