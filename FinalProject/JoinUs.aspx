<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="JoinUs.aspx.cs" Inherits="FinalProject.JoinUs" %>
                           ...
                           <div class="form-bottom">
                               ...
                               <div class="form-group">
                                   ...
                                   <asp:DropDownList ID="ddlgrade" runat="server" CssClass="form-control">
                                       ...
                                       <asp:ListItem Value="6600">6600</asp:ListItem>
                                       <asp:ListItem Value="4400">4400</asp:ListItem>
                                       <asp:ListItem Value="4200">4200</asp:ListItem>
                                   </asp:DropDownList>
